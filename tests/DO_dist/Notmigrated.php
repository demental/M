...
class DataObjects_Notmigrated extends DB_DataObject_Pluggable 
{
    ###START_AUTOCODE
    /* the code below is auto generated do not remove the above tag */

    public $__table = 'notmigrated';                     // table name
    ...
    /* Static get */
    function staticGet($k,$v=NULL) { return DB_DataObject::staticGet('DataObjects_Notmigrated',$k,$v); }
    ...
    ###END_AUTOCODE
    public $internationalFields = array('titre','description');
}
